...
function _mh5987355678() {
    ...
    this.TownIndexWindowSet = function () {
        $.Observer(GameEvents.ui.layout_mode.city_overview.activate).subscribe("TownIndexWindow", function (e, t) {
            o.TownIndexWindowOpen()
        }),
            $.Observer(GameEvents.ui.layout_mode.island_view.activate).subscribe("TownIndexWindow", function (e, t) {
                i = $("#ui_box .topleft_navigation_area .bull_eye_buttons .rb_map .option.island_view"),
                    null != n && n.close()
            }),
            $.Observer(GameEvents.ui.layout_mode.strategic_map.activate).subscribe("TownIndexWindow", function (e, t) {
